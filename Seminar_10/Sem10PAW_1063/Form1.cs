    ...
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //comanda.CommandText = "UPDATE studenti SET anStudiu=" + comboBox1.Text + " WHERE cod=" + cod;
                comanda.CommandText = "UPDATE studenti SET facultate='" + comboBox2.Text + "' WHERE cod=" + cod;
